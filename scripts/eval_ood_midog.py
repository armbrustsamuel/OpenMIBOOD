...
parser.add_argument('--postprocessor', choices=['ash', 'dice', 'dropout', 'ebo', 'fdbd', 'gen', 'klm', 'knn', 'mls', 'mds_ensemble', 'mds', 'nnguide', 'odin', 'openmax', 'rankfeat', 'react', 'relation', 'residual', 'rmds', 'scale', 'she', 'temp_scaling', 'vim', 'msp', 'autoencoder', 'autoencoder_nonorm', 'autoencoder_norm', 'vit_mahalanobis'], default='msp')
...
ckpt_path = os.path.join(root, 'midog_classifier.pth')
