...
class AutoencoderNonNorm(nn.Module):
    def __init__(self, latent_dim):
        super(AutoencoderNonNorm, self).__init__()
...
class AutoencoderNonNormPostprocessor(BasePostprocessor):
    def __init__(self, args):
        super().__init__(args)
        # Initialize your autoencoder model here
        self.autoencoder = AutoencoderNonNorm(latent_dim=32).cuda()
        ...
        print("Loading autoencoder weights from /content/autoencoder_no_norm_weights.pth")
        self.autoencoder.load_state_dict(torch.load("/content/autoencoder_no_norm_weights.pth"))
